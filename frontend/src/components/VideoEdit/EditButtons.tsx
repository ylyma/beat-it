    ...
    return (
      <View>
        <View style={styles.buttonContainer}>
          ...
          <TextInput
            placeholder={'Enter time delay in s'}
            onChangeText={val => setDelay(val)}
            inputMode="decimal"
            value={delay}
          ...
          />
          <TouchableOpacity
            style={[styles.functionButton, {backgroundColor: colors.secondary}]}
            onPress={() =>
              FFmpegWrapper.changeAudio(videoContext, delay, userId)
            }>
            <Text style={[styles.functionText, {color: colors.white}]}>
              Align Audio
            </Text>
          </TouchableOpacity>
        </View>
    ...
    return (
      <View>
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            style={[styles.functionButton, {backgroundColor: colors.secondary}]}
            onPress={() => FFmpegWrapper.mirrorVideo(videoContext, userId)}>
            <Text style={[styles.functionText, {color: colors.white}]}>
              Mirror Video
            </Text>
          </TouchableOpacity>
