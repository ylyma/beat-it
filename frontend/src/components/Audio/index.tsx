...
const AudioComponent: () => ReactElement = () => {
    ...
    const postAudio = async (file: any) => {
    ...
    return (
        <Container>
            <SearchBar
                icon={<Ionicons name="search" color={colors.alwaysblack} />}
                iconPosition="left"
                placeholder="Search"
                value={search}
            ...
            <PlaylistContainer refresh={uploadTop} setRefresh={setUploadTop} search={search} />
            <View style={styles.titleAndButton}>
            ...
            <Modal isVisible={isModalVisible}>
                <Modal.Container>
                    ...
                    <Modal.Body>
                        <Text style={[styles.modalText, { color: colors.text }]}>Enter Playlist name</Text>
                        <Input
                            placeholder={'Playlist name'}
                            placeholderTextColor={colors.alwaysblack}
                            onChangeText={(text: string) => setPlaylistTitle(text)}
                            style={{ color: colors.alwaysblack, backgroundColor: colors.grey }}
                        />
                    </Modal.Body>
                    <Modal.Footer>
                        <CustomButton
                            ...
                            onPress={() => {
                                handleModal();
                                navigate(PLAYLIST, { playlistTitle: playlistTitle, setRefresh: setUploadTop })
                            }}
                        />
                        <CustomButton
                            style={styles.modalButton}
