    ...
    const handleSignUp = async () => {
        ...
        await createUserWithEmailAndPassword(auth, email, password)
            .then(userCredential => {
                ...
                ToastAndroid.show('Registered with user: ' + user.email, ToastAndroid.SHORT);
            })
            .catch(error => {
        ...
        await signInWithEmailAndPassword(auth, email, password)
            .then(userCredential => {
                ...
                ToastAndroid.show('Signed in with user: ' + user.email, ToastAndroid.SHORT);
                navigate(LOGIN);
            }
            )
            .catch(error => {
                if (error.code === 'auth/invalid-email') {
                    ...
                    ToastAndroid.show('That email address is disabled!', ToastAndroid.SHORT);
                }

                else if (error.code === 'auth/user-not-found') {
                    console.log('That email address is not found!');
                    ToastAndroid.show('That email address is not found!', ToastAndroid.SHORT);
                }
