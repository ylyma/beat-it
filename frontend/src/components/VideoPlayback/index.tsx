import { View, Text, TouchableOpacity, Animated, ScrollView, Image, FlatList } from 'react-native'
...
const VideoPlaybackComponent = () => {
    ...
    const updateTime = (progress) => {
        ...
        setFramesLineOffset({ x: parseInt((progress.currentTime / progress.seekableDuration).toString()) * 80, y: 0 })
    }
